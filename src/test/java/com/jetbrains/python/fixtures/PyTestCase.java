...
public abstract class PyTestCase extends UsefulTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    TestFixtureBuilder<IdeaProjectTestFixture> fixtureBuilder = factory.createLightFixtureBuilder(String.valueOf(getProjectDescriptor()));
  ...
  public <T> void assertContainsInRelativeOrder(@NotNull final Iterable<T> actual, final T... expected) {
